<script>
  ...
  let botttsOptions = {
    ...
    colorful: colorful,
    mouthChance: mouthChance,
    sidesChance: sidesChance,
    textureChance: textureChance,
    topChance: topChance,
  };
  let jdenticonOptions = {
    hues: hues,
  ...
  (type === "male" || type === "female" || type === "human") && mood !== null
    ? (options.mood = mood)
    : null;
  (type === "identicon" || type === "bottts") && colors !== null
